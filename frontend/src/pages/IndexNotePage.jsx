        ...
        <div>
            <div className="flex justify-center mt-5">
                <div className="w-full md:w-11/12 lg:w-9/12 xl:w-7/12 flex justify-end">
                    <Link to={'/'} className="flex gap-1 bg-gray-100 px-2 py-1 rounded-2xl shadow-md shadow-gray-400 hover:ring-2 hover:ring-primary">
                ...
                <div className="w-full md:w-11/12 lg:w-9/12 xl:w-7/12">
                    <div className="flex flex-col p-2 gap-2 rounded-xl bg-gray-100 my-2 shadow-md shadow-gray-400" key={car._id}>
                        <div className="flex flex-row gap-2">
                            <div className="my-auto w-56">{photo.length > 0 && (<Image className="rounded-xl h-28 w-52 ring-2 ring-white shadow-md shadow-gray-400" src={photo} />)}</div>
