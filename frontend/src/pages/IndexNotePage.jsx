...
export default function IndexNotePage() {
  ...
  return (
    <div className='responsive xl:mx-44 '>
      <div className="flex justify-center my-5">
        <div className="flex flex-col w-full" key={car._id}>
          <div className='flex justify-between mb-1'>
            <div className='flex sm:text-xl xl:text-2xl gap-1'>
            ...
            <div className="flex flex-col justify-center">
              <Link to={'/'} className="flex gap-1 px-2 py-1 hover:bg-gray-50 hover:rounded-xl hover:shadow-md hover:shadow-gray-400 hover:ring-1 hover:ring-black">
                ...
                <div className='flex items-center'>Back to the garage</div>
              </Link>
            </div>
          </div>
          ...
          <div className='border-0 border-b border-gray-300 mb-4'></div>
