...
export default function NotePage() {
        ...
        return (
            <>
                ...
                <div className="flex justify-between">
                    ...
                    <div>
                        Mandatory: {countTypeOfServices()[0]}
                    </div>
                    <div>
                        Service: {countTypeOfServices()[1]}
                    </div>
                    <div>
                        One Time: {countTypeOfServices()[2]}
                    </div>
                </div>
                <div className="flex gap-0.5">
    ...
    return (
        <div>
                ...
                <div className="w-full md:w-11/12 lg:w-9/12 xl:w-7/12">
                    <div className="flex flex-col p-2 gap-2 rounded-xl bg-gray-100 my-2 shadow-md shadow-gray-400" key={car._id}>
                        ...
                        <div className="flex flex-row gap-2">
                            <div className="my-auto w-56">{photo.length > 0 && (<Image className="rounded-xl h-24 w-52 md:h-32 md:w-56 object-fit ring-2 ring-white shadow-md shadow-gray-400" src={photo} />)}</div>
            ...
            <div className="flex justify-center">
                <div className="w-full md:w-11/12 lg:w-9/12 xl:w-7/12">
                    {notes.length == 0 && (<div className="p-2 rounded-xl bg-gray-100 my-2 shadow-md shadow-gray-400">This car haven't got any notes!</div>)}
                    {notes.length > 0 && notes.map(note => (
                        <div className="flex flex-col p-2 rounded-xl bg-gray-100 my-2 shadow-md shadow-gray-400 hover:ring-2 hover:ring-primary group" key={note._id}>
                            <div className="flex justify-between">
                                ...
                                <div className="flex flex-col justify-center w-full text-sm lg:text-base tracking-tight">
                                    <div className="flex gap-0.5">
                                        ...
                                        <div className="flex gap-0.5 w-full">
                                            ...
                                            <div className="flex w-1/3 gap-0.5">
                                                <div className="flex flex-col justify-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
                                                    </svg>
                                                </div>
                                                <p className="flex flex-col justify-center">{note.typeOfService}</p>
                                            </div>
                                            <div className="flex w-1/3 gap-0.5">
                                                <div className="flex flex-col justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-9-6h.008v.008H12v-.008zM12 15h.008v.008H12V15zm0 2.25h.008v.008H12v-.008zM9.75 15h.008v.008H9.75V15zm0 2.25h.008v.008H9.75v-.008zM7.5 15h.008v.008H7.5V15zm0 2.25h.008v.008H7.5v-.008zm6.75-4.5h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V15zm0 2.25h.008v.008h-.008v-.008zm2.25-4.5h.008v.008H16.5v-.008zm0 2.25h.008v.008H16.5V15z" /></svg></div>
                                                <p className="flex flex-col justify-center">{format(new Date(note.timeOfService), 'yyyy-MM-dd')}</p>
                                            </div>
                                        </div>
            ...
            <div className="flex justify-center mt-4">
                <Link className="flex bg-green-400 text-gray-900 py-0.5 px-2 rounded-2xl shadow-md shadow-gray-400 gap-1 hover:ring-2 hover:ring-black" to={'/account/garage/' + id + '/notes/newNote'}>
