        ...
        <div>
            ...
            <div className="flex flex-col text-sm md:text-base">
                <div className="w-full md:w-11/12 lg:w-9/12 xl:w-7/12 m-auto">
                    {garage.length == 0 && (
                        <div className="bg-gray-100 p-2 rounded-2xl shadow-md shadow-gray-400">You haven't got any car in your garage!</div>
                    )}
                        ...
                        <div key={car._id}>
                            <Link to={'/account/garage/' + car._id + '/notes'} className="flex cursor-pointer gap-2 bg-gray-100 hover:bg-gray-200 hover:ring-2 hover:ring-primary p-2 rounded-2xl shadow-md shadow-gray-400 mb-3 relative" key={"notes/" + car._id}>
                                <div className="flex w-48">
                                    {car.photos.length > 0 && (
                                        <Image className="rounded-2xl w-full object-cover ring-2 ring-white shadow-md shadow-gray-400" src={car.photos[0]} />
                                    )}
                                </div>
                ...
                <div className="flex justify-center mt-4">
                    <Link className="flex bg-green-400 text-gray-900 py-0.5 px-2 rounded-2xl shadow-md shadow-gray-400 gap-1 hover:ring-2 hover:ring-black" to={'/account/garage/new'}>
